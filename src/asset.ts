 ...
 *
 * Canonical types (Email, Message, Contact, …) live in `scenecast/types/`.
 * Vendor implementations (Gmail, Slack, …) ship from benchmark repos like
 * `scenebench` as scenecast extensions, declaring `extends: ["email/mailbox"]`
 * to identify the canonical type they implement.
 *
