...
export const Email = defineAsset<EmailMailboxState>({
  ...
  mockState: () => ({
    messages: [
      ...
      { id: "m8",  from: "support@github.com",      to: ["me@x.com"], subject: "[scene-views] PR review",       body: "Alice approved your PR #44. Tests are green; ready to merge.",                                                                             unread: false, date: "2026-04-29T15:18:00Z" },
